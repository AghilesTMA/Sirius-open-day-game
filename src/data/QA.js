const QA = [
  ...
  {
    question:
      " What's your favorite excuse for not turning in homework on time?",
    answers: [
  ...
  {
    question:
      "If you had to survive on a deserted planet, what's the one item you'd bring?",
    answers: [
      {
  ...
  {
    question:
      "If you were to describe your study habits, which sci-fi character would best represent you?",
    answers: [
      {
  ...
  {
    question:
      "What's your preferred superpower for navigating the academic world of ESTIN Bejaia?",
    answers: [
      {
  ...
  {
    question:
      "If your school bag could talk, what would it complain about most?",
    answers: [
      {
      ...
      {
        text: "Losing my way in the cosmic abyss of your backpack.",
        type: "Rulerterra_27FF",
      },
    ],
  },
  {
    question:
      "If you had to choose an unusual extracurricular club at ESTIN Bejaia, which would it be?",
    answers: [
      {
        text: "Sirius club",
        type: "Funtopia_C78",
  ...
  {
    question:
      "If you could build an AI-powered IoT device to assist you at ESTIN Bejaia, what would it do?",
    answers: [
      {
  ...
  {
    question:
      "You've been tasked with creating an AI assistant for the Sirius Club's interstellar parties.",
    answers: [
      {
